...
| Devbox names | `fir-dev` (tunnel), `fir-dev(-2/-3)` (remote control) |
...
GPU nodes are 1 × EPYC 9454: 48 cores / 1125 GB / 4 H100. Stay below the ratio —
...
`diskusage_report` rather than trusting this table if in doubt.
